...
print("DEBUG: Iniciando web_main.py")
print(f"DEBUG: current_dir = {os.path.dirname(os.path.abspath(__file__))}")
print(f"DEBUG: root_dir = {os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__))))}")
